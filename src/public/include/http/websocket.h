#ifndef CPP_NETWORK_HTTP_WEBSOCKET_H_
#define CPP_NETWORK_HTTP_WEBSOCKET_H_
...
struct CPP_NETWORK_HTTP_EXPORT WsMessage {
...
enum class CPP_NETWORK_HTTP_EXPORT WsCloseCode : uint16_t {
  kNormal = 1000,
  kGoingAway = 1001,
  kProtocolError = 1002,
...
class CPP_NETWORK_HTTP_EXPORT WebSocket {
 public:
...
#endif  // CPP_NETWORK_HTTP_WEBSOCKET_H_
